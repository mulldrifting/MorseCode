...
+(NSDictionary*)delayDictionary
{
    ...
    dispatch_once(&onceToken, ^{
        inst = @{@"-": [NSNumber numberWithInt:300000], //dash
                 ...
                 @"|": [NSNumber numberWithInt:100000], //space between two pips
                 @" ": [NSNumber numberWithInt:300000], //space between two letters
                 @"*": [NSNumber numberWithInt:700000]}; //space between two words
